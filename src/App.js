...
<div>
<img className='supply-chain-img' src='./map-supply-chain.webp' alt = 'map-supply-chain'/></div>
      </div>
      ...
      <div>
        ...
        <input className='input-style'placeholder='Enter your email here'></input>
        <span><button className='btn-red'>Subscribe</button></span>
        </span>
      </div>
      </div>
      <Footer/>
